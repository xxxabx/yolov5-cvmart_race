...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if not os.path.exists('/project/train/models/last'):
        os.mkdir('/project/train/models/last')
    if not os.path.exists('/project/train/models/last'):
        os.mkdir('/project/train/models/best')
    
    
    last = Path('/project/train/models/last')/'last.pt'
    best = Path('/project/train/models/best')/'best.pt'
